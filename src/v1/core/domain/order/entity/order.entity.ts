...
import { AbstractOrderItemEntity } from '../../order-item/entity/order-item-entity.abstract';

export class OrderEntity extends Entity<string> {
  private _items: AbstractOrderItemEntity[];
